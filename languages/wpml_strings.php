...
"Handwritten Text",
"Optional handwritten text, leave empty to hide",
"Quick Contacts",
"Contact Info",
"Contact info.",
"Text Block Title",
...
"Hand written font",
"your text",
"Select the project you wish to be featured.",
"Optional image link.",
"Thumbnails + Slider",
"Footer menu",
"Footer Widgets",
...
"Show",
"Tagline",
"Whether to show the tagline area or not.",
"Default content of tagline area.",
"<h4>Hi there and welcome to <span class=\"accent\">Brandspace</span>, a new minimal multi-purpose WordPress Theme from <a href=\"#\">Pixelentity</a>. As with all of our themes, Brandspace is speedy, lightweight and bursting with the latest tech.</h4>",
"Custom Colors",
...
"Show Extra Section",
"Whether to show the extra footer section (social links/newsletter) or not.",
"Newsletter",
"Newsletter subscribe mail address, leave empty to disable newsletter block.",
...
"This is the site footer logo image.",
"Footer info block.",
"Widget Areas",
...
"Optional custom tagline message, leave empty to use default.",
"Bottom Border",
"Whether to add a bottom border to the tagline area or not.",
"Width",
...
"ongoing - Jun 2011",
"Optional link label, leave empty to hide.",
"Visit Site",
"Optional link url, leave empty to hide.",
...
"Contact Options",
"Image Caption",
"Optional image caption, will be shown on top of the featured image. If no featured image, the whole block will be hidden.",
"Quotation Request",
"Whether to show the quotation request area or not.",
"Quotation Select Box",
"Text content of the quotation select box.",
"Personal Box",
"Text content of the personal box.",
"Quotation Box",
"Text content of the quotation box.",
"Service Options",
"Add one or more service option.",
"Time of Day",
"Add one or more time option.",
"Message Box",
"Text content of the message box.",
"Related Projects",
"Add one or more related projects.",
"prev",
"next",
"Share This Post: ",
"Go",
